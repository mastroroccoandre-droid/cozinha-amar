        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <div style={{ fontFamily: 'DM Serif Display, serif', color: '#fff', fontSize: '15px', lineHeight: 1.2 }}>
              Residencial <span style={{ color: '#F0BABA' }}>Amar</span>
            </div>
            <div style={{ color: 'rgba(255,255,255,0.35)', fontSize: '9px', marginTop: '2px', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
        ...
        {NAV.map((group) => (
          <div key={group.section}>
            ...
            {group.items.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href} className={cn('sidebar-nav-item', active && 'active')} onClick={() => setMobileOpen(false)}>
                  <Icon size={16} />

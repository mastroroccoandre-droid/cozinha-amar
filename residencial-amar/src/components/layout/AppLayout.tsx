...
const NAV = [
  {
    ...
    items: [
      ...
      { href: '/producao', label: 'Produção do Dia', icon: ChefHat, badge: null },
    ],
  },
  {
    section: 'Cardápio',
  ...
  const SidebarContent = () => (
    ...
    >
      ...
      >
        ...
        >
          <Users size={14} style={{ color: '#5DCAA5' }} />
          <span style={{ color: '#5DCAA5', fontSize: '12px', fontWeight: 500 }}>
...
function PageTitle({ pathname }: { pathname: string }) {
  ...
  return (
    <span style={{ fontSize: '15px', fontWeight: 500 }}>
      {titles[pathname] ?? 'Residencial Amar'}
    </span>
  )
}
